...
saveRDS(d, "data_2018/d_20180301.rds")
...
m <- stan_model(file="source_2018/model_2018.stan")
...
s <- s.f(nchains=4, iter=100, warmup=20, thin=1, refresh=1)
saveRDS(s, "data_2018/model_samples_debug_4chains_100+100t2_20180301.rds")
