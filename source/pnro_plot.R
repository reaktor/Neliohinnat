...
spplot(pnro.hinnat.sp, zcol="lhinta", lwd=0.01, main="log.price")
spplot(pnro.hinnat.sp, zcol="trendi", lwd=0.01, main="trend")
spplot(pnro.hinnat.sp, zcol="quad", lwd=0.01, main="quadratic")
dev.off()
