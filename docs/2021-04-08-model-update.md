...
![*Yet another way to compare anomalousness of years is the idiosyncratic variation in the zip $\times$ year random effect. This is variation not explained by the zip-code hierarchy nor by covariates. The yearly standard deviations of the r.e. are parametrised to the model and shown above. Although there may be a border effect, year 2020 again looks to outperform.*](../figs/stds-of-slot-re.png)
